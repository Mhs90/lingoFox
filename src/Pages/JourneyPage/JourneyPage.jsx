                                ...
                                <div className="map">
                                    <div className="status">
                                        <div className="status-detail">
                                            <div className="journey-badge flag">
                                        ...
                                        <div className="status-detail">
                                            <div className="journey-badge clock">
                                        ...
                                        <div className="status-detail">
                                            <div className="journey-badge book">
                                        ...
                                        <div className="status-detail">
                                            <div className="journey-badge medal">
                                    ...
                                    <div className="journey-tasks">
                                        ...
                                        <div className="journey-task thirdTask continuingTask">
                                            <div className='foxTopOfContinuing'>
                                                <img
